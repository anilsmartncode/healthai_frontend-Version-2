...
const SLIDES: SlideItem[] = [
  { id: "slide1", image: require("@/assets/images/onboard.png") },
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#0F172A" }}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          // Each slide: full width, only image area height — no overflow
          <View
            style={{ width, height: imageAreaHeight, backgroundColor: "#fff" }}
          >
            <Image
              source={item.image}
              style={{ width, height: imageAreaHeight }}
              resizeMode="contain"
            />
          </View>
        )}
