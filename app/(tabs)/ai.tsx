...
export default function AIHomeScreen() {
  ...
  const handleUnderstandReports = async () => {
    ...
    try {
      ...
      const labReports = (list || []).filter(r => (r as any).reportType?.toUpperCase() !== 'PRESCRIPTION');
      ...
      const abnormal = (fullReport.values || []).filter((v: any) => v.status === 'high' || v.status === 'low');
          ...
          <View style={styles.mainContainer}>
            ...
            <View style={styles.header}>
              <View>
                ...
                <Text style={styles.headerSubtitle}>{t("onboard_title") || "Your intelligent health companion"}</Text>
              </View>
              <Pressable
            ...
            >
              ...
              <View style={styles.welcomeCard}>
                <Text style={styles.welcomeTitle}>{getGreeting(t)} {userName} 👋</Text>
                <Text style={styles.welcomeSubtitle}>{t("ai_how_can_help") || "How can I help with your health today?"}</Text>
              </View>
            ...
            >
              <View style={styles.inputWrap}>
                <TextInput
                  style={styles.input}
                  placeholder={t("ai_placeholder") || "Ask anything about your health..."}
