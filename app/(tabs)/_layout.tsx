...
export default function TabsLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        name="medicines"
        options={{ title: t('nav_medicines'), tabBarIcon: ({ color }) => <Ionicons name="medkit-outline" size={20} color={color} /> }}
      />
      <Tabs.Screen
        name="nearby"
      ...
      <Tabs.Screen
        name="ai"
        options={{ title: 'Ask AI', tabBarIcon: ({ color }) => <Ionicons name="chatbubbles-outline" size={20} color={color} /> }}
      />
      <Tabs.Screen
        name="profile"
